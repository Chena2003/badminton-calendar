      ...
      {form.submitted ? (
        <>
          ...
          <Card id="download_option_ical" className="mb-6">
            ...
            <p className="mb-4">{t('download.webcalDescription')}</p>
          ...
          <Card id="download_option_google" className="mb-6">
            ...
            {form.alarm && (
              <div className="bg-yellow-200 rounded-md shadow py-4 mb-5 px-4 text-black font-bold">
          ...
          <Card id="download_option">
            ...
            <p className="mb-4">{t('download.icsDescription')}</p>
            <a
